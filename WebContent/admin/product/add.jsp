...
<HTML>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-48" data-genuitec-path="/NetStore/WebContent/admin/product/add2.jsp">
		...
		<form action="${pageContext.request.contextPath }/adminProduct?method=adminAddProduct" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-48" data-genuitec-path="/NetStore/WebContent/admin/product/add2.jsp">
