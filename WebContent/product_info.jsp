...
<script type="text/javascript">
	function addToCart() {
		...
		alert(quantity);
		location.href = "${pageContext.request.contextPath}/product?method=addToCart&pid=${product.pid}&quantity" + quantity;
	}
</script>
<body>
	<!-- 引入header.jsp -->
		...
		<div class="row">
			<div
				...
				<a href="./index.jsp">首页&nbsp;&nbsp;&gt;</a><a
					href="${pageContext.request.contextPath }/product?method=pageProductList&cid=${category.cid }&currentPage=1">${category.cname }</a>
				<div style="margin: 0 auto; width: 950px;">
					...
					<div class="col-md-6">
						<div>
							<strong style="color:orange;">${product.pname }</strong>
						</div>
						<div
