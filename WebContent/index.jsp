	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProduct }" var="hotPro">
						...
						<a href="${pageContext.request.contextPath }/product?method=showProductInfo&pid=${hotPro.pid}">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="/${pageContext.request.contextPath }/product_info.jsp">
					...
					<c:forEach items="${newProduct }" var="newPro">
						<div class="col-md-2 yes-right-border" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product?method=showProductInfo&pid=${newPro.pid}">
